...
module.exports = {
    ...
    subtract: function (x, y) { return apply((x, y) => x - y, x, y); },
    multiply: function (x, y) { return apply((x, y) => x * y, x, y); },
    divide: function (x, y) { return apply((x, y) => x / y, x, y); },
    power: function (x, y) { return apply((x, y) => x ** y, x, y); }
}
