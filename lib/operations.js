...
module.exports = {
    ...
    min: function (x, y) { return apply10(Math.min, x, Infinity); },
    max: function (x, y) { return apply10(Math.max, x, -Infinity); },
    sum: function (x, y) { return apply10((x, y) => x + y, x, 0); },
    prod: function (x, y) { return apply10((x, y) => x * y, x, 1); }
}
