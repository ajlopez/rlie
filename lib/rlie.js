...
context.set('rbind', function (args) { return vectors.rbind(args); });
context.set('cbind', function (args) { return vectors.cbind(args); });
context.set('nrow', function (args) { return operations.nrow(args[0]); });
context.set('ncol', function (args) { return operations.ncol(args[0]); });
context.set('dim', function (args) { return operations.dim(args[0]); });
...
context.set('abs', function (args) { return operations.abs(args[0]); });
